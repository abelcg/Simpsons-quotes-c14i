...
function App() {
 ...
 /*  const character = {
  ...
  //operador ternario
  // (condición lógica) ? (código a ejecutar cuando es verdadero (true)) : (código a ejecutar cuando es false) 
  ...
  return (
    <section className="container my-5 d-flex flex-column align-items-center">
      ...
      {/* {showComponent} */}
      { loading ? <Quotes character={character}></Quotes> :  <Spinner/>}
    </section>
  );
}
